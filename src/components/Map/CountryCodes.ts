export const countryCodes: { [key: string]: { alpha2: string; alpha3: string; numeric: string } } = {
    ...
    "British Indian Ocean Territory": { alpha2: "IO", alpha3: "IOT", numeric: "086" },
    ...
    "Cayman Islands": { alpha2: "KY", alpha3: "CYM", numeric: "136" },
    "Central African Republic": { alpha2: "CF", alpha3: "CAF", numeric: "140" },
    ...
    "Cocos (Keeling) Islands": { alpha2: "CC", alpha3: "CCK", numeric: "166" },
    ...
    "Cook Islands": { alpha2: "CK", alpha3: "COK", numeric: "184" },
    ...
    "Dominican Republic": { alpha2: "DO", alpha3: "DOM", numeric: "214" },
    ...
    "Falkland Islands": { alpha2: "FK", alpha3: "FLK", numeric: "238" },
    "Faroe Islands": { alpha2: "FO", alpha3: "FRO", numeric: "234" },
    ...
    "French Southern Territories": { alpha2: "TF", alpha3: "ATF", numeric: "260" },
    ...
    "Holy See": { alpha2: "VA", alpha3: "VAT", numeric: "336" },
    ...
    "Lao People's Democratic Republic": { alpha2: "LA", alpha3: "LAO", numeric: "418" },
    ...
    "Marshall Islands": { alpha2: "MH", alpha3: "MHL", numeric: "584" },
    ...
    "Northern Mariana Islands": { alpha2: "MP", alpha3: "MNP", numeric: "580" },
    ...
    "Russian Federation": { alpha2: "RU", alpha3: "RUS", numeric: "643" },
    ...
    "Sint Maarten": { alpha2: "SX", alpha3: "SXM", numeric: "534" },
    ...
    "Turks and Caicos Islands": { alpha2: "TC", alpha3: "TCA", numeric: "796" },
    "Tuvalu": { alpha2: "TV", alpha3: "TUV", numeric: "798" },
    "Uganda": { alpha2: "UG", alpha3: "UGA", numeric: "800" },
    "Ukraine": { alpha2: "UA", alpha3: "UKR", numeric: "804" },
    "United Arab Emirates": { alpha2: "AE", alpha3: "ARE", numeric: "784" },
    "United Kingdom": { alpha2: "GB", alpha3: "GBR", numeric: "826" },
    "United States Minor Outlying Islands": { alpha2: "UM", alpha3: "UMI", numeric: "581" },
    "United States of America": { alpha2: "US", alpha3: "USA", numeric: "840" },
